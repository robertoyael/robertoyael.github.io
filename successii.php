...
var updates = {};
updates['/Users/'+uid+"/"+"nivel2"] = idVend;
  ...
  title: 'Gracias!!',
  text: "La suscripcion fue todo un exito",
  confirmButtonColor: '#3085d6',
  confirmButtonText: ' Continuar'
}).then((result) => {
  if (result.isConfirmed) {
    window.location='insi.html'
...
<body>
<input type='submit' name='submit' class="button3" onclick='registrarCompra()' value='Continuar Compra'>
